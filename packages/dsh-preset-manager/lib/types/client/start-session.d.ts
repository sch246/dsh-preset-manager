 ...
 */
export declare function startPresetSession(actions: PresetSessionStartActions, presetId: string, workspaceId?: WorkspaceId): Promise<PresetManagerKey | undefined>;
